...
export function cargarEstructura3(container) {
    ...
    floor.position.y = -1; // Ajustá este número según qué tan abajo lo quieras
    scene.add(floor);
    ...
    rayParallelIncident.layers.set(1);
    rayParallelReflected.layers.set(1);
    rayCentralIncident.layers.set(1);
    rayCentralReflected.layers.set(1);
    rayImagen.layers.set(1);
